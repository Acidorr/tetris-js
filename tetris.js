...
function arenaSweep() {
  let rowCount = 1;
  outer: for (let y = arena.length - 1; y > 0 ; --y) { //using label outer so we can continue iterating from the top
...
function playerDrop (){
  ...
  dropCounter = 0; //restart one second delay after player forces piece down
}
